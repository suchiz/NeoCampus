...
public class PanelFirstMessage extends JPanel {
	...
	public void initcomponent() {
		...
		panelFirstMessageLayout.setHorizontalGroup(panelFirstMessageLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panelFirstMessageLayout.createSequentialGroup().addGap(117, 117, 117)
						.addComponent(buttonEnvoyer, javax.swing.GroupLayout.PREFERRED_SIZE, 100,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 125, Short.MAX_VALUE)
						.addComponent(buttonAnnuler, javax.swing.GroupLayout.PREFERRED_SIZE, 100,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(87, 87, 87))
				.addComponent(textFieldFirstMessage, javax.swing.GroupLayout.Alignment.TRAILING));
		panelFirstMessageLayout.setVerticalGroup(panelFirstMessageLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panelFirstMessageLayout.createSequentialGroup()
						...
						.addGap(18, 18, 18)
						.addGroup(panelFirstMessageLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(buttonEnvoyer).addComponent(buttonAnnuler,
	...
	private void envoieMessage() throws IOException {
		...
		System.out.println(panelSelectionGroupes.getGroupeSelected().getListeUtilisateur());
	...
	private boolean checkFields() {
		if (panelSelectionGroupes.getGroupeSelected() == null || textFieldFirstMessage.getText().equals("")
				|| textFieldFirstMessage.getText().equals("Ecrivez votre message...")
				|| textFieldTitre.getText().equals("")) {
