...
public class PanelFilDeDiscussion extends JPanel{
	...
	private void test (){
		...
		DefaultMutableTreeNode node2 = new DefaultMutableTreeNode(new FilDeDiscussion("Discussion 1", g1, new Etudiant("nom", "prenom")));
		DefaultMutableTreeNode node3 = new DefaultMutableTreeNode(new FilDeDiscussion("Discussion 2", g1, new Etudiant("nom", "prenom")));
		DefaultMutableTreeNode node4 = new DefaultMutableTreeNode(new FilDeDiscussion("Discussion 3", g1, new Etudiant("nom", "prenom")));
